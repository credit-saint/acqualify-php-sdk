...
namespace Acqualify\Client\Model;

use \ArrayAccess;
use \Acqualify\Client\ObjectSerializer;

/**
 * AddrLine2 Class Doc Comment
 *
 * @category Class
 * @package  Acqualify\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddrLine2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'addrLine2';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addr_line2'] === null) {
            $invalidProperties[] = "'addr_line2' can't be null";
        }
